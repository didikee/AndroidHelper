...
/**
 * Created by didikee on 04/07/2017.
 */
...
public class ZipUtil {
     ...
     * @throws Exception
     */
    public static void unZipFolder(String zipFileString, String outPathString, String folderName) throws Exception {
        ...
        inZip.close();
        FileUtil.renameFile(new File(outPathString + File.separator + oldFolderName), new File(outPathString + File.separator + folderName));
    }

    public static void unZipFolder(String zipFileString, String outPathString) throws Exception {
        unZipFolder(zipFileString, outPathString, null);
    }
